                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-4">
                                    <div class="float-end d-none d-md-block">
                                        <div class="dropdown">
                                            <a href="{{route('skills.CategoryList')}}" class="btn btn-primary" type="button">
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        @endif
                                        <form method="POST" action="{{ url('/update-skills-category')}}/{{$skillCategory->id}}" enctype="multipart/form-data" >
                                            @csrf

                                            <div class="mb-3">
                                                <label class="form-label">Select Unit/Department</label>
                                                <select class="form-control select2" name="unit_id">
                                                    <option value="">Select</option>
                                                    @foreach($unit as $data)
                                                        <option value="{{$data->iid}}" @if($skillCategory->unit_id == $data->iid) selected @endif>{{$data->unit_name}}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" maxlength="50" name="cat_name" id="cat_name_defaultconfig" value="{{$skillCategory->name}}">
                                                 @error('cat_name')<span class="text-danger" role="alert">{{ $message }}</span>@enderror
                                            </div>

                                            <div class="mb-3">
                                                <label>Slug</label>
                                                <input type="text" class="form-control" maxlength="50" name="cat_slug" id="cat_slug_defaultconfig" value="{{$skillCategory->slug}}">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea id="elm1" class="form-control" name="description" maxlength="225" rows="3" placeholder="This textarea has a limit of 225 chars.">{{$skillCategory->description}}</textarea>
                                            </div>
