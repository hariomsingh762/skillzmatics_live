                            ...
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    ...
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Profile Password Page</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-8 col-lg-6 col-xl-4">
                                ...
                                @if(Session::get('changePassMessage'))
                                 ...
                                 @endif
                                            <form class="mt-4" method="POST" action="{{ route('admin.profilePasswordUpdateSetting') }}">
                                                @csrf
                                                <div class="mb-3">
                                                    <label class="form-label" for="old_pass">Old Password</label>
                                                    <input type="password" class="form-control" name="old_pass" id="old_pass" placeholder="Enter old Password" value="">
                                                ...
                                                <div class="mb-3">
                                                    <input type="password" class="form-control" name="password_confirmation" id="userpassword" placeholder="Confirm Password" value="">
