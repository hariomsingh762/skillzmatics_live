                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <!-- item-->
                                <a class="dropdown-item" href="route('admin.profileConfiguration')"><i class="mdi mdi-account-circle font-size-17 align-middle me-1"></i> Profile</a>
                                <a class="dropdown-item" href="{{route('admin.profileUpdateSetting')}}"><i class="mdi mdi-wallet font-size-17 align-middle me-1"></i> Update Profile</a>
                                <a class="dropdown-item" href="{{route('admin.profilePasswordSetting')}}"><i class="mdi mdi-wallet font-size-17 align-middle me-1"></i> Change Password</a>
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <!-- <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    ...
                                    <li><a href="{{route('posts.postsCategory')}}">Categories</a></li>
                                </ul>
                            </li> -->
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{route('skills.addCheckList')}}">Add</a></li>
                                    <li><a href="{{route('skills.checkList')}}">List</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{route('skills.addUnit')}}">Add</a></li>
                                    <li><a href="{{route('skills.unitList')}}">List</a></li>
                                </ul>
                            </li>
                            ...
                            <!--    </a>-->
                            <!--    <ul class="sub-menu" aria-expanded="false">-->
                            <!--        <li><a href="{{route('skills.CategoryAdd')}}">Add</a></li>-->
                            <!--        <li><a href="{{route('skills.CategoryList')}}">List</a></li>-->
                            <!--    </ul>-->
                            <!--</li>-->
                            ...
                            <li>
                                <a href="javascript: void(0);" class="has-arrow waves-effect">
                                    <i class="ti-list"></i>
                                    <span>Skill Check List Item</span>
                                </a>
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{route('skills.CategoryItemAdd')}}">Add</a></li>
                                    <li><a href="{{route('skills.CategoryItemList')}}">List</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="{{route('skills.UserReview')}}" class="has-arrow waves-effect">
                                    <i class="ti-list"></i>
