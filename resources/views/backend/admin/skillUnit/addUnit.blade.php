                    ...
                    <div class="container-fluid">
                        ...
                        <div class="page-title-box">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h6 class="page-title">Add Unit</h6>
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="#">Skillz Matics</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Add Unit</a></li>
                                    </ol>
                                </div>
                                <div class="col-md-4">
                                    <div class="float-end d-none d-md-block">
                                        <div class="dropdown">
                                            <a href="{{route('skills.unitList')}}" class="btn btn-primary" type="button">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="alert alert-success" role="alert">
                                            <strong>Well done!</strong> You successfully Added Skills Unit.
                                        </div>
                                        @endif
                                        <form method="POST" action="{{route('skills.addUnitStore')}}" enctype="multipart/form-data" >
                                            @csrf
                                            <div class="mb-3">
                                                <label>Unit Name</label>
                                                <input type="text" class="form-control" maxlength="50" name="unit_name" id="unit_name_defaultconfig">
                                                 @error('unit_name')<span class="text-danger" role="alert">{{ $message }}</span>@enderror
                                            </div>

                                            <div class="mb-3">
                                                <label>Slug</label>
                                                <input type="text" class="form-control" maxlength="50" name="unit_slug" id="unit_slug_defaultconfig">
