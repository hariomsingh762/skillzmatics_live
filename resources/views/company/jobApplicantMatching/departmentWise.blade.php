...
@section('title', 'Department Wise Job Listing')
        ...
        <div class="container-fluid">
            ...
            <div class="page-title-box">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h6 class="page-title">All Department Wise Job Listing</h6>
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="#">Skillz Matics</a></li>
                            <li class="breadcrumb-item"><a href="#">Department Wise </a></li>
                            ...
                            <div class="accordion-item border rounded mt-2">
                                <h2 class="accordion-header" id="heading{{$index}}">
                                    <button class="accordion-button fw-semibold"
                                        onclick="redirectToRoute('{{ route('company.departmentWise', ['departmentID' => $data['id']]) }}')">
                                        <ol class="breadcrumb m-0">
